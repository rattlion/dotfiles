" Base16 MREVD (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/bash ".g:base16_shell_path."/base16-mrevd.".&background.".sh > /dev/null"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-mrevd"
